...
namespace WebPrimeMotors.Repositorio
{
    public class VeiculoRepositorio : IVeiculoRepositorio
    {
        ...
        public VeiculoModel Atualizar(VeiculoModel veiculo)
        {
            ...
            if (veiculoDB == null) throw new System.Exception("Houve um erro na atualizacao do catato!");
        ...
        public bool Apagar(int id)
        {
            ...
            if (veiculoDB == null) throw new System.Exception("Houve um erro na delecao do catato!");
